...
if button1:
  option = st.selectbox(
    ...
    ('5', '6', '7', '8', '9', '10'))
  if '5':
    a= st.str(input("Ingresa volumen 1: "))
    b= st.str(input("Ingresa volumen 2: "))
    c= st.str(input("Ingresa volumen 3: "))
    d= st.str(input("Ingresa volumen 4: "))
    e= st.str(input("Ingresa volumen 5: "))
